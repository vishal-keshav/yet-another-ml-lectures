...
def fire_module(input_tensor, nr_squeeze_1, nr_expand_1, nr_expand_3, args):
    ...
    expand_3_tensor = Conv2D(filters = nr_expand_3, kernel_size = (3,3), strides=(1,1), dilation_rate=(args.dilation, args.dilation),
                    activation='relu', padding='same', kernel_initializer='glorot_uniform')(squeeze_tensor)
...
def define_model(input_shape, output_class, args):
    ...
    tensor = Conv2D(filters = 96, kernel_size = (3,3), strides = (1,1), padding = 'same', dilation_rate=(args.dilation, args.dilation),
    ...
    for i in range(8):
        ...
        tensor = fire_module(tensor, nr_squeeze_1, nr_expand_1, nr_expand_3, args)
